...
namespace IIS.Celiii
{
    ...
    public class Рекомендац : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РекомендацE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РекомендацE", typeof(IIS.Celiii.Рекомендац));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРекомендац : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Celiii.DetailArrayOfРекомендац members)

        // *** End programmer edit section *** (IIS.Celiii.DetailArrayOfРекомендац members)
        ...
        /// </summary>
        public DetailArrayOfРекомендац(IIS.Celiii.ПричинУвольн fПричинУвольн) : 
                base(typeof(Рекомендац), ((ICSSoft.STORMNET.DataObject)(fПричинУвольн)))
        {
        }
        
        public IIS.Celiii.Рекомендац this[int index]
        {
            get
            {
                return ((IIS.Celiii.Рекомендац)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Celiii.Рекомендац dataobject)
        {
