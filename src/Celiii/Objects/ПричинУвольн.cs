...
namespace IIS.Celiii
{
    ...
    [AssociatedDetailViewAttribute("ПричинУвольнE", "Рекомендации", "РекомендацE", true, "", "Рекомендации", true, new string[] {
            ""})]
    [AssociatedDetailViewAttribute("ПричинУвольнE", "Список", "СписокАнкетE", false, "", "Список анкет", true, new string[] {
            ""})]
    ...
    public class ПричинУвольн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Celiii.DetailArrayOfРекомендац fРекомендации;
        
        private IIS.Celiii.DetailArrayOfСписокАнкет fСписок;
        ...
        public virtual IIS.Celiii.DetailArrayOfРекомендац Рекомендации
        {
            get
            {
                ...
                {
                    this.fРекомендации = new IIS.Celiii.DetailArrayOfРекомендац(this);
                }
                IIS.Celiii.DetailArrayOfРекомендац result = this.fРекомендации;
        ...
        public virtual IIS.Celiii.DetailArrayOfСписокАнкет Список
        {
            get
            {
                ...
                {
                    this.fСписок = new IIS.Celiii.DetailArrayOfСписокАнкет(this);
                }
                IIS.Celiii.DetailArrayOfСписокАнкет result = this.fСписок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнE", typeof(IIS.Celiii.ПричинУвольн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнL", typeof(IIS.Celiii.ПричинУвольн));
                }
            }
        }
    }
