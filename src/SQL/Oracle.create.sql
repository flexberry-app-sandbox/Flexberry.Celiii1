...
(
	...
	"ОценРабот" NVARCHAR2(17) NULL,

	"ГлавнПричин" NVARCHAR2(13) NULL,
...
ALTER TABLE "СписокАнкет"
	ADD CONSTRAINT "СписокАнкет_F_9574" FOREIGN KEY ("Анкеты") REFERENCES "Анкеты" ("primaryKey");

CREATE INDEX "СписокАнкет_I_7845" on "СписокАнкет" ("Анкеты");

ALTER TABLE "СписокАнкет"
	ADD CONSTRAINT "СписокАнкет_F_7804" FOREIGN KEY ("ПричинУвольн") REFERENCES "ПричинУвольн" ("primaryKey");

CREATE INDEX "СписокАнкет_I_5628" on "СписокАнкет" ("ПричинУвольн");
